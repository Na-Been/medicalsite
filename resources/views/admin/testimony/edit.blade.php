                ...
                <div style="border-right:1px solid #b0b0b033;padding-right:30px">
                    <div>
                        ...
                        <input type="text" class="input w-full border mt-2" name="name"
                               placeholder="Input name" value="{{$testimony->name}}">
                        @error('name')
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="form-control summary-ckeditor"
                                  name="designation">{!! $testimony->designation !!}</textarea>
                            @error('designation')
                            <div class="text-theme-6">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-2">
                        <textarea class="form-control summary-ckeditor"
                                  name="review">{!! $testimony->review !!}</textarea>
                            @error('review')
                            <div class="text-theme-6">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div>
                        <label>Rating</label>
                        <input type="number" class="input w-full border mt-2" name="rating"
                               placeholder="Input rating" value="{{$testimony->rating}}">
                        @error('rating')
                        <div class="text-theme-6">{{$message}}</div>
                        @enderror
                    </div>
