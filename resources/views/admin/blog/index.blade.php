    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="{{route('blog.create')}}">
                <button class="button text-white bg-theme-1 shadow-md mr-2">Add New Blog</button>
            </a>
        </div>
        <!-- BEGIN: Data List -->
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2" id="example" style="width:100%">
                ...
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">ADDED BY</th>
                    <th class="text-center whitespace-no-wrap">BLOG TITLE</th>
                ...
                @foreach($blogs as $blog)
                    <tr class="intro-x">
                            ...
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    ...
                                    <img alt="blog image" class="tooltip rounded-full"
                                         ...
                                         title="Updated at {{$blog->updated_at}}">
                                    @else
                        ...
                        <td class="text-center">{!! Str::limit(ucfirst($blog->description),20) !!}</td>

                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{route('blog.show',$blog->id)}}"> <i
                                        data-feather="eye"
                                        class="w-4 h-4 mr-1"></i> View
                                </a>
                                <a class="flex items-center mr-3" href="{{route('blog.edit',$blog->id)}}"> <i
                                        data-feather="check-square"
                                        class="w-4 h-4 mr-1"></i> Edit
                                </a>
                                <a class="flex items-center text-theme-6 delete" href="javascript:;" data-toggle="modal"
                                   data-target="#delete-confirmation-modal" data-value="{{$blog->id}}"> <i
