    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            ...
            <a class="flex items-center text-theme-6 delete" href="javascript:;" data-toggle="modal"
               data-target="#delete-confirmation-modal" data-value="{{$blog->id}}"> <i data-feather="trash-2"
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <div>
                ...
                <h1>Image</h1><br/>
                @if($blog->image)
                    <img src="{{asset(url('/').Storage::url($blog->image))}}" style="width: 200px; height: 150px;">
                @else
