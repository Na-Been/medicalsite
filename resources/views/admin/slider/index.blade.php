        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2" id="example" style="width:100%">
                ...
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">SUB TITLE</th>
                    ...
                    <tr class="intro-x">
                                ...
                                <div class="w-10 h-10 image-fit zoom-in">
                                    @if($slider->image)
                                        <img alt="blog image" class="tooltip rounded-full"
                                             ...
                                             title="Updated at {{$slider->updated_at}}">
                                    @else
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{route('slider.show',$slider->id)}}"> <i
                                        data-feather="eye"
                                        class="w-4 h-4 mr-1"></i> View
                                </a>
                                <a class="flex items-center mr-3" href="{{route('slider.edit',$slider->id)}}"> <i
                                        data-feather="check-square"
                                        class="w-4 h-4 mr-1"></i> Edit
                                </a>
                                <a class="flex items-center text-theme-6 delete" href="javascript:;" data-toggle="modal"
                                   data-target="#delete-confirmation-modal" data-value="{{$slider->id}}"> <i
