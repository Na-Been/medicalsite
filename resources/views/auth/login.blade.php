                ...
                <div class="block xl:grid grid-cols-2 gap-4">
                    ...
                    <div class="hidden xl:flex flex-col min-h-screen">
                        <a href="" class="-intro-x flex items-center pt-5">
                            ...
                            {{--                                         src="{{asset('assets/images/logo.svg')}}">--}}
                            {{--                            @endif--}}
                            {{--                            <span class="text-white text-lg ml-3"> {{$setting->title ?? 'Company Title'}} </span>--}}
                        </a>
                        <div class="my-auto">
                    ...
                    <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                        <div
                            ...
                            <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">A few more clicks to sign in
                                to your account. Manage all your accounts in one place
                            </div>
                            <div class="intro-x mt-8">
                                ...
                                @if(session()->has('loginFailed'))
                                    <div class="text-theme-6">{{session()->get('loginFailed')}}</div>
                                @endif
